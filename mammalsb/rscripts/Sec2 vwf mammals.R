...
dfFilteredSingle <- dfRag[!duplicated(species_name)][, .(accession_number, species_name)]
...
dfTraits[habitat_breadth == "4", habitat_breadth := NA][, habitat_breadth := droplevels(habitat_breadth)]

dfPreCentroid <- merge(dfRag, dfTraits, by = "species_name")[, 1:3]
